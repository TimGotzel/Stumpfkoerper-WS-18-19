...
%-------------------------------------------------------------------------------------
Modi et al. \cite{MODI.1991} versucht durch drehende Zylinder den Widerstand zu reduzieren. Dabei werden unterschiedliche Modelle genutzt. F"ur erste Versuche wird das Modell in \abb{fig:Modi3} und sp"ater der Truck aus \abb{fig:Modi} verwendet.
\begin{figure}[h]
	\centering
