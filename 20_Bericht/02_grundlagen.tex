...
Die Wirbel innerhalb der turbulenten Str"omung  zerfallen kaskadenartig in kleinere Wirbel und dissipieren dabei ihre Energie in W"arme, bis sie sich g"anzlich aufl"osen und sich erneut ein laminares Str"omungsprofil ausbildet. Dennoch ergibt sich im Nachlauf des stumpfen K"orpers, welcher sich an das Totwasser anschlie\ss{}t, eine Delle im Geschwindigkeitsfeld. Das ist in Abbildung \abb{fig:Nachlauf} zu sehen. Aus dem Nachlauf lassen sich deshalb Informationen "uber den Widerstand des K"orpers ziehen, was im Abschnitt \ref{s:widerstandsbestimmung} weiter thematisiert wird. 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{LaminareAbloeseblase.jpg}
