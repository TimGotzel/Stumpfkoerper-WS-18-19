...
Der Rechen, der die Dr"ucke liefert, muss zu diesem Zwecke so platziert werden, dass die Nachlaufdelle komplett aufgenommen wird. 
...
%Hierzu eignet sich der bisheriger Erfahrung nach \textit{Shao}:
%
%	\begin{equation}
...
%	\end{equation}
%	
%Wobei $p_{min}$ dem niedrigsten Druck im Nachlauf entspricht, sowie $a$ und $b$ Modellparameter sind.
